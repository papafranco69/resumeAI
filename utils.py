...
class Utils:
    ...
    def one_gram_sim(self, text_str, skill_str):
        ...
        try:
            #using spacy similarity(), it uses cosine similarity by default
            vec_similarity = token1.similarity(token2)
            return vec_similarity
        except:
            # try Jaro–Winkler similarity if words not found in spacy corpus
            str_distance_similarity = jellyfish.jaro_similarity(
