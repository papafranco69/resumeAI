...
from general_params import GRAM_REDUNDANT, LIST_PUNCTUATIONS
...
def remove_punctuation(
    ...
    Examples
    --------
    >>> from  cleaner import remove_punctuation
    >>> text = "Hello there, I am  ! Annoation, annotation, annotation ..."
    >>> print(remove_punctuation(text))
    Hello there  I am    Annoation  annotation  annotation
    """
...
def remove_redundant(
    text: str,
    list_redundant_words: List[str] = GRAM_REDUNDANT,
) -> str:
    ...
    Examples
    --------
    >>> from cleaner import remove_redundant
...
def remove_extra_space(
    ...
    Examples
    --------
    >>> from  .cleaner import remove_extra_space
...
def find_index_phrase(
    ...
    Examples
    --------
    >>> from  .cleaner import find_index_phrase
    >>> text = "you have professional experience building React apps, you are familiar with version control using git and GitHub"
