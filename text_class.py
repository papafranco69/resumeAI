...
from general_params import GRAM_REDUNDANT
...
class Text:
    ...
    def __init__(
        ...
        # transformed text: lower + remove punctuation + remove extra space
        ...
        for redundant_word in GRAM_REDUNDANT:
    ...
    def __getitem__(
        ...
        >>> text_obj = Text("Fluency in both English and French is mandatory")
        >>> text_obj[3]
        < .text_class.Word at 0x1cf13a9bd60>
        >>> print(text_obj[3])
        english
        """
    ...
    def words_start_end_position(text: str) -> List[Word]:
        ...
        >>> nlp = spacy.load('en_core_web_sm')
        >>> from  .text_class import Text
        >>> list_words = Text.words_start_end_position("Hello World I am  ")
        >>> word_1 = list_words[0]
